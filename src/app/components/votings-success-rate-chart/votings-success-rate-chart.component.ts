...
export class VotingsSuccessRateChartData {
  ...
  public static fromFaction(faction: FactionLightDto): VotingsSuccessRateChartData {
    return new VotingsSuccessRateChartData(faction.name, faction.votingsSuccessRate * 100);
  }
