...
export function calcSpeakingTimeOfFaction(faction: RegistryFaction, sessions: SessionInput[]): number {
  return sessions
    .flatMap(session => {
...
export function calcSpeakingTimeOfParty(party: RegistryParty, sessions: SessionInput[]): number {
  return sessions
    .flatMap(session => {
...
export function calcSpeakingTimeOfPerson(person: RegistryPerson, sessions: SessionInput[]): number {
  return sessions
